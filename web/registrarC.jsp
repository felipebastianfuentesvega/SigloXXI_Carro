                ...
                <div class="login-box-body">
                    ...
                    <form role="form" id="form" action="ClienteServlet"  method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <button class="btn btn-primary btn-block btn-flat" type="submit" name="accion" onclick="confirmarCambios(),alert('Sus datos han sido modificados!');" value="RegistrarC">Registrar</button>
                            </div>
                        </div>
                    </form>
                    <div class="row">
